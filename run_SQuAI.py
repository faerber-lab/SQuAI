...
class EnhancedCitationHandler:
    ...
    def _extract_context_passage(self, answer_text: str, document_text: str, citation_num: int) -> str:
        """
        Main extraction method that chooses between semantic and word-overlap methods
        """
    ...
    def _extract_context_passage_original(
        self, answer_text: str, document_text: str, citation_num: int
    ) -> str:
        """Original word-overlap based extraction method (kept for backward compatibility)"""
        try:
    ...
    def _basic_fallback(self, document_text: str, max_chars: int = 300) -> str:
        """
...
Remember: Use information from MULTIPLE documents and cite each one appropriately with [{citation_examples}]. Answer:"""
    ...
    def answer_query(self, query, db=None, choices=None, should_split=None, sub_questions=None):
        ...
        with time_block("total_4agent_processing"):
            ...
            citation_handler = EnhancedCitationHandler(self.index_dir, retriever=self.retriever)
